...
class CalculatorTest {
    ...
    void testGreaterWithGreater() {
        assertTrue(calculator.checkIfGreater(10, 0), "10 > 0 should be true");
    }

    @Test
    @DisplayName("Test checkIfGreater with a greater number, should return False")
    void testGreaterWithlesser() {
        assertFalse(calculator.checkIfGreater(0, 10), "0 > 10 should be false");
    }

    @Test
    @DisplayName("Test checkIfLesser with a greater number, should return True")
    void testLesserWithGreater() {
        assertTrue(calculator.checkIfLesser(0, 10), "0 < 10 should be true");
    }

    @Test
    @DisplayName("Test checkIfLesser with a greater number, should return True")
    void testLesserWithlesser() {
        assertFalse(calculator.checkIfLesser(10, 0), "10 < 0 should be false");
    }
}